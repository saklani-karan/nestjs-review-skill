...
- Skill packaged at **`skills/nestjs-pr-review/SKILL.md`** so **`gh skill install saklani-karan/nestjs-review-skill`** discovers the repository (GitHub CLI expects `skills/*/SKILL.md`).
- `SKILL.md` dispatcher with scoring rubric, rule index, review workflow, and structured output format.
- Twelve self-contained reference files under `skills/nestjs-pr-review/references/`, one per rule:
...
- `README.md` with install instructions for Claude Code, Cursor, and other Agent Skills-compatible hosts, including manual install (clone and copy `skills/nestjs-pr-review/`) and `gh` CLI install instructions.
- MIT license.
...
[Unreleased]: https://github.com/saklani-karan/nestjs-review-skill/compare/v1.0.0...HEAD
